...
module.exports.userLogin = function(req, res) {
  sql.connect(webconfig, function(err) {
    ...
    request1.query('select * from Album; select * from Sanatci; select * from MuzikTur;', function(err, verisonucu) {
      if (err) {
        console.log(err);
      }
...
module.exports.albumeklemeGet = function(req, res) {
  sql.connect(webconfig, function(err) {
    ...
    request1.query('select * from Sanatci; select * from MuzikTur;', function(err, verisonucu) {
      ...
      sql.close();
      res.render('albumekle', { veri: verisonucu.recordsets });
    });
  });
};
...
module.exports.albumguncelle1 = function(req, res) {
  sql.connect(webconfig, function(err) {
    ...
    request1.query('select * from Sanatci; select * from MuzikTur;', function(err, verisonucu) {
      ...
      sql.close();
      res.render('album_guncelle', { veri: verisonucu.recordsets, guncellenecek_album_id: req.body.GuncellenecekAlbumId });
    });
  });
};
